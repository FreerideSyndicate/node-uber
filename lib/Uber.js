...
function Uber(options) {
	this.defaults = {
		...
		name: options.name,
		sandbox: (typeof options.sandbox != "undefined" && options.sandbox) ? true : false,
		base_url: 'https://api.uber.com/',
		authorize_url: 'https://login.uber.com/oauth/authorize',
		access_token_url: 'https://login.uber.com/oauth/token'
	};

	if (this.defaults.sandbox) {
		this.defaults.base_url = 'https://sandbox-api.uber.com/';
	}
